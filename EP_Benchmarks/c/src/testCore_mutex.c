...
#include <stdio.h>
#include <math.h>
#include "e-lib.h" //Epiphany library
#include "common.h" //Shared 
...
*/
	...
	if (t > 1)
       ...
       /* Calculate the multiplier for the values in this pair, and multiply */
        ...
        /* Update the appropriate counter in shared memory, corresponding to the maxXY value */
